...
--
-- Client: sql207.byetcluster.com
-- Généré le: Dim 07 Août 2016 à 18:35
-- Version du serveur: 5.6.30-76.3
...
--
-- Base de données: `b16_16262608_screenbaseDB`
--
...
CREATE TABLE IF NOT EXISTS `screens` (
  ...
  `nav` varchar(128) DEFAULT NULL,
  `tag01` varchar(32) DEFAULT NULL,
  `tag02` varchar(32) DEFAULT NULL,
  `tag03` varchar(32) DEFAULT NULL,
  `tag04` varchar(32) DEFAULT NULL,
  `tag05` varchar(32) DEFAULT NULL,
  `tag06` varchar(32) DEFAULT NULL,
  `tag07` varchar(32) DEFAULT NULL,
  `tag08` varchar(32) DEFAULT NULL,
  `tag09` varchar(32) DEFAULT NULL,
  `tag10` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(46, 'http://img15.hostingpics.net/pics/681677bonjet.jpg', NULL, '78.248.96.82', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.82 Safari/537.36', 'high', 'noob', 'sacri', 'bouftou', 'orchidÃ©e', 'swag', NULL, NULL, NULL, NULL),
(47, 'http://img15.hostingpics.net/pics/348922cachzaap.png', NULL, '78.248.96.82', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.82 Safari/537.36', 'zaap', 'frigost', 'cachÃ©', 'orchidÃ©e', NULL, NULL, NULL, NULL, NULL, NULL),
